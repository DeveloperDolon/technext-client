    ...
    <>
      <div className="bg-indigo-50 dark:bg-black dark:text-white min-h-screen">
        <div className="xl:px-20 md:px-10 sm:px-6 px-4 md:py-12 py-9 2xl:mx-auto 2xl:container md:flex items-center justify-center">
          ...
          <div className="shadow-lg rounded xl:w-1/3 lg:w-5/12 md:w-1/2 w-full lg:px-10 sm:px-6 sm:py-10 px-2 py-6">
            <p
              tabIndex={0}
            ...
            <button
              ...
              role="button"
              className="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 p-3 border rounded-lg border-gray-700 dark:border-white flex items-center w-full mt-10 hover:bg-gray-100"
            >
              <svg
                width={19}
                height={20}
              ...
              <p className="text-base font-medium ml-4 text-gray-700 dark:text-gray-400">
            ...
            <button
              ...
              role="button"
              className="focus:outline-none dark:border-white focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 p-3 border rounded-lg border-gray-700 flex items-center w-full mt-4 hover:bg-gray-100"
            >
              <svg
                width={21}
                height={20}
            ...
            <button
              ...
              role="button"
              className="focus:outline-none focus:ring-2 focus:ring-offset-1 dark:border-white focus:ring-gray-700 p-3 border rounded-lg border-gray-700 flex items-center w-full mt-4 hover:bg-gray-100"
            >
              <svg
                width={24}
                height={24}
            ...
            <FormProvider {...methods}>
              <form onSubmit={methods.handleSubmit(onSubmit)}>
                ...
                <div className="mt-6 w-full">
                  <label
                    htmlFor="myInput"
                    className="text-sm font-medium leading-none text-gray-800 dark:text-white"
                  >
                    {" "}
                    Password{" "}
                  </label>
